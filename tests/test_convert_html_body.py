...
class TestHTML2SPSPipeline(unittest.TestCase):
    ...
    def test_pipe_a_anchor__remove_top(self):
        text = """<root><a href="#top"><graphic xmlns:ns2="http://www.w3.org/1999/xlink" ns2:href="/img/revistas/gs/v29n2/seta.gif"/></a></root>"""
